...
void Language::LoadES() {
    m_strings = {
        ...
        { "tray.quit",          "Salir" },
        // ConfigDialog
        { "cfg.title",              "FileCopier \u2014 Configuraci\u00f3n" },
        { "cfg.tab.lang",           "Idioma" },
        { "cfg.tab.startup",        "Arranque" },
        { "cfg.tab.settings",       "Ajustes de copia" },
        { "cfg.tab.behavior",       "Comportamiento" },
        { "cfg.tab.errors",         "Informe de errores" },
        { "cfg.tab.process",        "Procesos" },
        { "cfg.tab.perf",           "Rendimiento" },
        { "cfg.tab.advanced",       "Avanzado" },
        { "cfg.startup",            "Arranque autom\u00e1tico" },
        { "cfg.autostart",          "Arrancar con Windows" },
        { "cfg.activateOnStart",    "Activar la aplicaci\u00f3n al iniciar" },
        { "cfg.newList",            "Manipulaci\u00f3n de listas de copia nuevas" },
        { "cfg.newList.add",        "A\u00f1adir a la lista existente" },
        { "cfg.newList.replace",    "Reemplazar la lista existente" },
        { "cfg.newList.ask",        "Preguntar siempre" },
        { "cfg.deletion",           "Supresi\u00f3n" },
        { "cfg.del.always",         "Suprimir archivos no copiados completamente" },
        { "cfg.del.noError",        "No suprimir si fue causado por un error de copia" },
        { "cfg.rename",             "Retitulaci\u00f3n" },
        { "cfg.rename.old",         "Patr\u00f3n para archivos viejos:" },
        { "cfg.rename.new",         "Patr\u00f3n para archivos nuevos:" },
        { "cfg.errorLog",           "Informe de errores" },
        { "cfg.autoSaveLog",        "Guardar autom\u00e1ticamente el informe de errores" },
        { "cfg.logPath",            "Carpeta:" },
        { "cfg.logName",            "Nombre del archivo:" },
        { "cfg.process",            "Integraci\u00f3n de procesos" },
        { "cfg.process.name",       "Proceso a interceptar:" },
        { "cfg.process.info",       "FileCopier interceptar\u00e1 las operaciones de copia/pegado del proceso indicado (por defecto: explorer.exe). Requiere reinicio." },
        { "cfg.advanced",           "Avanzado" },
        { "cfg.priority",           "Prioridad del proceso:" },
        { "cfg.priority.normal",    "Normal" },
        { "cfg.priority.low",       "Baja" },
        { "cfg.priority.high",      "Alta" },
        { "btn.ok",                 "Aceptar" },
    };
}
...
void Language::LoadEN() {
    m_strings = {
        ...
        { "tray.quit",          "Quit" },
        // ConfigDialog
        { "cfg.title",              "FileCopier \u2014 Configuration" },
        { "cfg.tab.lang",           "Language" },
        { "cfg.tab.startup",        "Startup" },
        { "cfg.tab.settings",       "Copy Settings" },
        { "cfg.tab.behavior",       "Behavior" },
        { "cfg.tab.errors",         "Error Report" },
        { "cfg.tab.process",        "Processes" },
        { "cfg.tab.perf",           "Performance" },
        { "cfg.tab.advanced",       "Advanced" },
        { "cfg.startup",            "Automatic Startup" },
        { "cfg.autostart",          "Start with Windows" },
        { "cfg.activateOnStart",    "Activate application on start" },
        { "cfg.newList",            "New copy list behavior" },
        { "cfg.newList.add",        "Add to existing list" },
        { "cfg.newList.replace",    "Replace existing list" },
        { "cfg.newList.ask",        "Always ask" },
        { "cfg.deletion",           "Deletion" },
        { "cfg.del.always",         "Delete files not completely copied" },
        { "cfg.del.noError",        "Don't delete if caused by a copy error" },
        { "cfg.rename",             "Renaming" },
        { "cfg.rename.old",         "Pattern for old files:" },
        { "cfg.rename.new",         "Pattern for new files:" },
        { "cfg.errorLog",           "Error Report" },
        { "cfg.autoSaveLog",        "Automatically save error report" },
        { "cfg.logPath",            "Folder:" },
        { "cfg.logName",            "File name:" },
        { "cfg.process",            "Process Integration" },
        { "cfg.process.name",       "Process to intercept:" },
        { "cfg.process.info",       "FileCopier will intercept copy/paste operations from the specified process (default: explorer.exe). Requires restart." },
        { "cfg.advanced",           "Advanced" },
        { "cfg.priority",           "Process priority:" },
        { "cfg.priority.normal",    "Normal" },
        { "cfg.priority.low",       "Low" },
        { "cfg.priority.high",      "High" },
        { "btn.ok",                 "OK" },
    };
}
